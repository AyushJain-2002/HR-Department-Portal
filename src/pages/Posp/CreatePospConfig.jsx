...
import { fetchDepartments,  fetchDesignation,} from "../../store/Actions/Department_Designation_Action";
...
export default function CreatePospConfig(formData) {
  ...
  useEffect(() => {
        if (!bqpList || bqpList.length === 0) dispatch(fetchBqp());
            ...
            },
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  placeholder: "Select a city",
                  step: 1,
                  dependsOn: ["permanent_address_state","same_as_permanent"],
                  required: true,
                  storeLabel: true,
                  createOpt: false,
